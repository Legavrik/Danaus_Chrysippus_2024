...
# import vcf
callset = allel.read_vcf('eu40.vs.dchry2.3.autosome.DP8_100.GQ20.vcf.gz',  fields=['calldata/GT', 'samples'])
...
# output to file
pca.to_csv("pca.eu40.vs.dchry2.3.autosome.csv", index=False)

with open('pca.eu40.vs.dchry2.3.autosome.explained_variance.txt', 'w') as f:
