...
# general parameters
outfile_name='res/testAfr_simu' # root of the output files
...
Nmin=2 # lower bound for the population size in each time window (in log10 scale)
Nmax=6 # upper bound for the population size in each time window (in log10 scale)
