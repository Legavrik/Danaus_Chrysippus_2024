...
infile_obs="res/ex1_Jersey_n30_mac6_macld6.stat"
...
# plot
pdf('res/ex1_Jersey_mac6_macld6_estim.pdf',height=4,width=4)
...
plot(abc_res,param=log10_pop(params)[,-1],file='res/ex1_Jersey_mac6_macld6_detailed',subsample=20)
