...
np.savetxt('obs.stats/obs_tajimas_d.csv', tajimas_d_values, delimiter=',', header='Tajimas_D', comments='')
...
np.savetxt('obs.stats/simul_h12_h2h1.csv', h12array, delimiter=',', header='H1,H12,H123,H2_H1', comments='')
np.savetxt('obs.stats/midpositions.csv', middle_positions, delimiter=',', comments='')
