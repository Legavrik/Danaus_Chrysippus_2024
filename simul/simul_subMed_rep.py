...
# Parameters
num_samples = 17 # msprime and pop gen models assume diploidy
sequence_length = 100
...
demographic_file = 'subMed_Ne_500'
historical_ne = []
...
#Calculate the SFS
sfs_table = np.zeros((int(num_replicates), int(2*num_samples+1))) #the afs generated by branch method always contain 2N+1 elements despite folded
...
# Save SFS to a file
sfs_filename = 'siteFS/simul.subMed'+sys.argv[1]+'.sfs'
np.savetxt(sfs_filename, sfs_mean, delimiter=",")
