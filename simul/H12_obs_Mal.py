...
file_path = "/data/martin/genomics/analyses/Danaus_popgen/europe/2_variants/simul/temp/subsamples_Mal.vcf.gz"
...
np.savetxt('obs.stats/obs_h12_h2h1_Mal.csv', h12array, delimiter=',', header='H1,H12,H123,H2_H1', comments='')
...
print(H12_in_region)
np.savetxt('obs.stats/Blocus_h12_Mal.csv', H12_in_region, delimiter=',', comments='')
np.savetxt('obs.stats/obs_h12_h2h1_Mal_windows.csv', window_positions, delimiter=',', comments='')
np.savetxt('obs.stats/obs_h12_h2h1_Mal.Blocus', H12_in_region, delimiter=',', comments='')
# Record end time
end_time = tm.time()
