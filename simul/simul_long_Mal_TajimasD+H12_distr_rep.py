...
window_size_h = 1000
step_size_h = 1000
filename = 'simul.stats/simul_Mal_distr_tajimasD_rep'+sys.argv[1]+'.csv'
filename_h = 'simul.stats/simul_Mal_distr_H12_rep'+sys.argv[1]+'.csv'
...
for sim in range(num_simulations):
    ...
    tajimasD_values.append(tajimas_d_values)
...
np.savetxt(filename, tajimasD_values, delimiter=',', comments='')
np.savetxt(filename_h, H12_values, delimiter=',', comments='')
